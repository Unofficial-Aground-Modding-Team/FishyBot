...
class Modio_User(LoadableDataclass):
    ...
    display_name_portal: Optional[str] = None  # discord username, if applicable
...
@dataclass
class Modio_Games(Modio_QueryResults):
    data: list[Modio_Game]

@dataclass
class Modio_Mods(Modio_QueryResults):
    data: list[Modio_Mod]

@dataclass
class Modio_Events(Modio_QueryResults):
    data: list[Modio_Event]

@dataclass
class Modio_Comments(Modio_QueryResults):
    data: list[Modio_Comment]
